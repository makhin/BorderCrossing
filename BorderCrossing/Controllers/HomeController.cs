...
namespace BorderCrossing.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult LoadFile(LocationHistoryFilePostRequest model)
        {
            ...
            {
                var dateRangePostRequest = _borderCrossingService.PrepareLocationHistory(model.LocationHistoryFile);
        ...
        {
            var borderCrossingResponse = _borderCrossingService.ParseLocationHistory(model);
